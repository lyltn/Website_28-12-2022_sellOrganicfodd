            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Enter the verification code</h2>
                        
                        <form  class="register-form"  action="{{URL::to('/createpass')}}" method="post">
                             {{csrf_field()}}
                            
                            <div class="form-group">
                                <label for="email"><i class="zmdi zmdi-email"></i></label>
                                <input type="text"  name="code" id="email" placeholder="Enter the verification code"/>
                            </div>
         
                            <div class="form-group form-button">
                                <input type="submit"  id="signup" class="form-submit" value="ok"/>
                            </div>
                        </form>
                    </div>
